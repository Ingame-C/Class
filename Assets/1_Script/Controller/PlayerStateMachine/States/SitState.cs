...
namespace Class.StateMachine
{
    public class SitState : StateBase
    {
        ...
        public override void Enter()
        {
            ...
            Camera.main.transform.position = new Vector3(Camera.main.transform.position.x, Camera.main.transform.position.y - 0.4f, Camera.main.transform.position.z - 0.1f);
        }
